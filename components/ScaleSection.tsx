  ...
  return (
    <section className="py-24 px-4 bg-mtg-blue relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        <div className="inline-block px-4 py-1 bg-white/10 rounded-full text-white text-[10px] font-black uppercase tracking-[0.3em] mb-6">
        ...
        <div className="bg-white/5 border border-white/10 p-10 rounded-2xl backdrop-blur-md max-w-2xl mx-auto shadow-2xl">
          <p className="text-mtg-orange font-black uppercase tracking-widest text-xs mb-6">
            Prerequisite: +30% Lead Growth Achieved
          </p>
          <p className="text-2xl text-gray-200 leading-relaxed mb-6 font-medium">
            Ready for <span className="text-white border-b-2 border-mtg-orange pb-1">Strategic Dominance?</span> 
          </p>
          <p className="text-gray-400 mb-10 text-lg">
            When your system is performing at peak capacity, we transition to Tier 3 expansion for total market capture.
          </p>

          <div className="space-y-6">
            <h4 className="text-white font-bold text-xl uppercase tracking-widest">
              Activate Strategic Dominance
            </h4>
            <div className="flex flex-col sm:flex-row justify-center items-stretch gap-4">
               ...
               <a href="sms:4402909067" className="flex items-center justify-center gap-2 px-8 py-4 bg-white text-mtg-blue rounded font-black uppercase tracking-widest hover:bg-gray-100 transition-all transform hover:scale-105 shadow-xl">
