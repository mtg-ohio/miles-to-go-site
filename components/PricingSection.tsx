...
const PricingSection: React.FC = () => {
  return (
    <SectionWrapper title="What It Costs." className="bg-slate-50">
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <div className="relative pt-4">
          <div className="absolute -top-0 left-6 bg-mtg-orange text-white px-4 py-1.5 rounded text-[10px] font-black uppercase tracking-widest shadow-lg z-20">Stage 2: Keep It Going</div>
