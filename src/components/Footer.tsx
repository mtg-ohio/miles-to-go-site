...
const Footer: React.FC = () => {
  return (
    <footer className="bg-mtg-soft-white border-t border-mtg-warm-gray/20">
      <div className="container mx-auto py-8 px-4">
        <div className="relative flex flex-col md:flex-row md:justify-between md:items-center gap-6">
          ...
          <div className="text-center md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2">
            <p className="text-sm font-bold text-mtg-rust tracking-widest opacity-90 whitespace-nowrap">
              GET FOUND. GET CHOSEN. GET CUSTOMERS.
            </p>
          </div>

          <div className="text-center md:text-right text-mtg-charcoal opacity-70 text-sm space-y-1">
            <a
              href="mailto:michael@milestogoohio.com"
              className="flex items-center justify-center md:justify-end hover:text-mtg-rust transition-colors"
            >
