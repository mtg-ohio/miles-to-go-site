...
5. Build Settings: 
  ...
  return (
    <SectionWrapper title="Owner's Deployment Guide." id="launch-section" className="bg-mtg-near-black text-white overflow-hidden relative border-t border-mtg-rust/30">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <p className="text-lg text-mtg-warm-gray mb-12 text-center">
          MTG Local Calls Delivered is built for <strong>Instant, Easy Updates</strong>. 
          Follow these simple steps to link your GitHub repository to Netlify.
        </p>

        <div className="grid md:grid-cols-2 gap-8 text-left mb-12">
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-xl flex flex-col h-full">
            <h3 className="text-xl font-bold text-mtg-rust mb-6 flex items-center">
              <GlobeIcon className="w-6 h-6 mr-3" />
              GitHub → Netlify Setup
            </h3>
            <ol className="space-y-5 text-sm text-white/80 flex-grow">
              <li className="flex items-start">
                <span className="bg-mtg-rust w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black mr-3 mt-0.5 shrink-0 text-white">1</span>
                <span><strong>Initialize:</strong> Create a new repository on GitHub and upload these files.</span>
              </li>
              <li className="flex items-start">
                <span className="bg-mtg-rust w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black mr-3 mt-0.5 shrink-0 text-white">2</span>
                <span><strong>Connect:</strong> Login to Netlify, click 'Add New Site' and choose 'Import from existing project'.</span>
              </li>
              <li className="flex items-start">
                <span className="bg-mtg-rust w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black mr-3 mt-0.5 shrink-0 text-white">3</span>
                <span><strong>Authorize:</strong> Connect your GitHub account and select your repository.</span>
              </li>
              <li className="flex items-start">
                <span className="bg-mtg-rust w-6 h-6 rounded-full flex items-center justify-center text-[10px] font-black mr-3 mt-0.5 shrink-0 text-white">4</span>
          ...
          <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-xl">
            ...
            <div className="mt-10 pt-8 border-t border-white/10 text-center">
              <p className="text-[10px] text-mtg-warm-gray italic mb-3 uppercase tracking-widest">Support Line for MTG Infrastructure</p>
              <p className="text-2xl font-black text-white tracking-tighter">440.290.9067</p>
            </div>
          </div>
        </div>

        <div className="bg-mtg-rust p-8 rounded-2xl text-center shadow-2xl">
